...
<div class="row">
    <div class="col-md-4">
        <div class="card p-1">
            <img src="{{ url('assets/wisata/'.$profil->picture) }}" class="img-fluid img-card-top">
        </div>
    </div>
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-6">
                        <b>Kategori (Dalam Bahasa Inggris)</b> <br>
                        {{ $profil->category->name_en }}
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-12">
                ...
                <div class="row mb-2">
                    <div class="col-md-12">
                        ...
                        <a href="{{ $profil->link_maps }}" target="_blank">
                            {{ $profil->link_maps }}
                        </a>
                    </div>
                </div>
