                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('address') is-invalid @enderror" name="address"
                            ...
                            required>{{ old('address') ? old('address') : $tour->address }}</textarea>
                        @error('address')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('facilities') is-invalid @enderror" name="facilities"
                            ...
                            required>{{ old('facilities') ? old('facilities') : $tour->facilities }}</textarea>
                        @error('facilities')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('facilities_en') is-invalid @enderror" name="facilities_en"
                            ...
                            autocomplete="off"
                            required>{{ old('facilities_en') ? old('facilities_en') : $tour->facilities_en }}</textarea>
                        @error('facilities_en')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                            ...
                            required>{{ old('description') ? old('description') : $tour->description }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <img id="addImage" src="{{ url('assets/wisata/' . $tour->picture) }}" class="mb-3 img-thumbnail"
                    ...
                    <div class="form-group">
                        ...
                        <input name="link_facebook" class="form-control @error('link_facebook') is-invalid @enderror"
                            id="link_facebook"
                            value="{{ old('link_facebook') ? old('link_facebook') : $tour->link_facebook }}" type="text"
                    ...
                    <div class="form-group">
                        ...
                        <input name="link_tiktok" class="form-control @error('link_tiktok') is-invalid @enderror"
                            id="link_tiktok" value="{{ old('link_tiktok') ? old('link_tiktok') : $tour->link_tiktok }}"
                    ...
                    <div class="form-group">
                        ...
                        <input name="link_youtube" class="form-control @error('link_youtube') is-invalid @enderror"
                            id="link_youtube"
                            value="{{ old('link_youtube') ? old('link_youtube') : $tour->link_youtube }}" type="text"
                    ...
                    <div class="form-check">
                        <input class="form-check-input btn-outline-primary" name="mitra_status" type="checkbox"
                            value="1" {{ $tour->mitra_status == '1' ? 'checked' : '' }}
                            id="defaultCheck1">
