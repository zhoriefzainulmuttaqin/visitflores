                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                id="name" placeholder="Nama" value="{{ old('name') }}" required autocomplete="off">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror"
                                ...
                                placeholder="Masukan Konfirmasi Password . . . " value="{{ old('password_confirmation') }}"
                                required autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('code_reff') is-invalid @enderror"
                                name="code_reff" id="code_reff" placeholder="K = Kuningan M = Majalengka I = Indramayu"
                                value="{{ old('code_reff') }}" required autocomplete="off">
                            @error('code_reff')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('commission_percent') is-invalid @enderror"
                                name="commission_percent" id="commission_percent" placeholder="20"
                                value="{{ old('commission_percent') }}" required autocomplete="off">
                        ...
                        <div class="mb-2 my-3">
                            ...
                            <input class="form-control @error('ktp') is-invalid @enderror" type="file" name="ktp"
                                id="ktp" onchange="previewImage()" required>
                            @error('ktp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
