    ...
    <div class="row mt--2">
        <div class="col-md-12">
            <div class="card" style="padding-bottom: 15px;">
                ...
                <form method="POST" action="{{ url('app-admin/data/berita/proses-tambah') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" name="content" placeholder="Masukkan Kontent . . ." rows="10" required>{{ old('content') }}</textarea>
                            <div class="my-3"></div>
                        </div>
                        <div class="form-group">
                            <label for="content_en">Konten (Dalam Bahasa Inggris)</label>
                            <textarea id="content_en" name="content_en" placeholder="Masukkan Kontent . . ." rows="10"required>{{ old('content_en') }}</textarea>
                            <div class="my-3"></div>
                        </div>
                        <div class="form-group">
