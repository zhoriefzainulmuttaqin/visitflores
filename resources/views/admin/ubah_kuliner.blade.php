                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="address"
                                placeholder="Masukan Alamat . . . " required autocomplete="off" required>{{ old('address') ? old('address') : $restaurant->address }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="link_maps" class="form-control @error('link_maps') is-invalid @enderror"
                                id="link_maps" value="{{ old('link_maps') ? old('link_maps') : $restaurant->link_maps }}"
                        ...
                        <div class="form-group">
                            ...
                            <input name="link_tiktok" class="form-control @error('link_tiktok') is-invalid @enderror"
                                id="link_tiktok"
                                value="{{ old('link_tiktok') ? old('link_tiktok') : $restaurant->link_tiktok }}"
                        ...
                        <div class="form-check">
                            <input class="form-check-input btn-outline-primary" name="cafe_resto" type="checkbox"
                                value="1" {{ $restaurant->cafe_resto == '1' ? 'checked' : '' }} id="defaultCheck1">
                        ...
                        <div class="form-check">
                            <input class="form-check-input btn-outline-primary" name="mitra_status" type="checkbox"
                                value="1" {{ $restaurant->mitra_status == '1' ? 'checked' : '' }}
                                id="defaultCheck1">
                            <label class="form-check-label" for="defaultCheck1">
                                Mitra UJICOBANTT
                            </label>
