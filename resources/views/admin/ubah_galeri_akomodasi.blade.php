...
@section('title')
    Ubah Galeri Akomodasi {{ $accomodation->name }}
@endsection
        ...
        <div class="col-md-12">
            <div class="card" style="padding-bottom: 15px;">
                <div class="card-header">
                    <h3 class="card-title">Ubah Galeri Akomodasi</h3>
                </div>
                <form method="POST" action="{{ url('app-admin/data/galeri/akomodasi/proses-ubah') }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                id="name" placeholder="Masukan Nama . . . " value="{{ old('name') ?? $gallery->name }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name_en') is-invalid @enderror" name="name_en"
                                ...
                                value="{{ old('name_en') ?? $gallery->name_en }}" required autocomplete="off"></input>
                            @error('name_en')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img id="addImage" src='{{ url("/assets/akomodasi/$gallery->picture") }}'
                            ...
                            <input class="form-control @error('picture') is-invalid @enderror" type="file" name="picture"
                                id="picture" onchange="previewImage()">
                            @error('picture')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
