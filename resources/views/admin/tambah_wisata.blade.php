                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('facilities_en') is-invalid @enderror" name="facilities_en" id="facilities_en"
                                placeholder="Masukan Fasilitas (Dalam Bahasa Inggris) . . . " required autocomplete="off" required>{{ old('facilities_en') }}</textarea>
                            @error('facilities_en')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                placeholder="Masukan Deskripsi . . . " required autocomplete="off" required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="link_instagram"
                                ...
                                value="{{ old('link_instagram') }}" type="url"
