                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name_en') is-invalid @enderror" name="name_en"
                            ...
                            value="{{ old('name_en') ? old('name_en') : $shop->name_en }}" required
                            autocomplete="off">
                        @error('name_en')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('address') is-invalid @enderror" name="address"
                            ...
                            required>{{ old('address') ? old('address') : $shop->address }}</textarea>
                        @error('address')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="link_maps" class="form-control @error('link_maps') is-invalid @enderror"
                            id="link_maps"
                            value="{{ old('link_maps') ? old('link_maps') : $shop->link_maps }}"
