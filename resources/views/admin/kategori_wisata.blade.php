...
@section('content')
<!-- Modal Edit -->
<form method="post" action="<?= url("app-admin/data/wisata/kategori/proses-ubah") ?>">
    @csrf
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            ...
            <form method="POST" action="{{ url('app-admin/data/wisata/kategori/proses-tambah') }}">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ url('app-admin/data/wisata/kategori/proses-hapus/' . $category->id) }}"
