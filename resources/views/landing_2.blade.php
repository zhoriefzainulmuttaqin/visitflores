  ...
  ============================================= -->
      ...
      ============================================= -->
                        <div id="logo">
                            <a href="{{ url('/') }}" class="ps-2">
                                <img class="logo-default py-1" srcset="{{ url('images/logo-visit.png') }}"
                                    src="{{ url('images/logo-visit.png') }}" alt="Logo UJICOBANTT">
                                <img class="logo-dark py-1" srcset="{{ url('images/logo.png') }}"
                                    src="{{ url('images/logo-visit.png') }}" alt="Logo UJICOBANTT">
                            </a>
                        </div><!-- #logo end -->
       ...
       ============================================= -->
                            <nav class="primary-menu d-none d-sm-none d-md-none d-lg-block d-xl-block">
                                <ul class="menu-container one-page-menu">
                                    ...
                                    <li class="menu-item"><a class="menu-link" href="#"
                                            data-href="#section-testimonials">
                                            <div>Testimonials</div>
                                        </a></li>
                                    <li class="menu-item"><a class="menu-link" href="#"
                                            data-href="#section-specs">
                                            <div>Specifications</div>
                                        </a></li>
                                    <li class="menu-item">
                                        <a class="menu-link" href="#" data-href="#section-buy">
                                            <div>
                                                Buy Now
                                                <i
                                        ...
                                        <ul class="sub-menu-container mega-menu-dropdown p-lg-0">
                                            <li class="menu-item">
                                                <a class="menu-link" href="menu-dropdowns-blur.html">
                                                    <div>Blur</div>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link" href="menu-dropdowns-colors.html">
                                                    <div>Colors</div>
                                                </a>
                                            </li>
                                        </ul>
       ...
       ============================================= -->
                            <div id="top-notif" class="header-misc-icon">
                                <a href="#"><i class="bi-bell"></i><span
                                        class="top-cart-number bg-danger">5</span></a>
                            </div><!-- #top-notif end -->
                            <!-- Top Cart
       ============================================= -->
      ...
      ============================================= -->
                        <nav class="primary-menu d-block d-sm-block d-md-block d-lg-none d-xl-none">
                            ...
                            <ul class="menu-container">
                                ...
                                <li class="menu-item d-block d-md-none d-xl-none mb-3">
                                    <a class="menu-link btn btn-danger btn-sm" href="#"
                                        data-href="#section-buy">
                                        <div>
                                            <i class="uil-signin"></i>
                                            Login
                                        </div>
        ...
        <section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100 dark include-header"
            style="background: url(<?= url('images/gedung.png') ?>) center center no-repeat; background-size: cover">
                            ...
                            <div class="row col-mb-50">
                                <div class="col-md-4">
                                    ...
                                    <div class="widget">
                                        ...
                                        <img src="{{ url('canvas') }}/images/footer-widget-logo.png" alt="Image"
                                            class="footer-logo">
