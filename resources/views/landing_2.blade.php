					...
					<div class="header-row">
						...
						<div id="logo">
							<a href="{{ url('/') }}" class="ps-2">
								...
								<img class="logo-dark py-1" srcset="{{ url('images/logo.png') }}" src="{{ url('images/logo-visit.png') }}" alt="Logo Visit Cirebon">
							</a>
						</div><!-- #logo end -->
                        ...
                        <div class="header-misc ms-auto justify-content-lg-end">
							...
							<nav class="primary-menu d-none d-sm-none d-md-none d-lg-block d-xl-block">
								<ul class="menu-container one-page-menu">
									...
									<li class="menu-item"><a class="menu-link" href="#" data-href="#section-pricing"><div>Pricing</div></a></li>
							...
							<div class="row col-mb-50">
								<div class="col-md-4">
									...
									<div class="widget">
										...
										<img src="{{ url('canvas') }}/images/footer-widget-logo.png" alt="Image" class="footer-logo">
