    ...
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('app-affiliate/keluar') }}"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ url('app-affiliate') }}" class="brand-link">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="{{ url('app-affiliate/profil') }}"
                            class="d-block">{{ Auth::guard('affiliators')->user()->name }}</a>
                        <span class="text-white">{{ Auth::guard('affiliators')->user()->code_reff }}
                            {{ Auth::guard('affiliators')->user()->location->name }}</span>
                    </div>
                </div>
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('app-affiliate/dashboard') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @if (in_array(Auth::guard('affiliators')->user()->code_reff, ['K1', 'M1', 'I1']))
                                    <li class="nav-item">
                                        <a href="{{ url('app-affiliate/data/affiliate/anggota') }}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Affiliate Anggota</p>
                                        </a>
                                    </li>
                                @endif
