...
<meta http-equiv="content-type" content="text/html; charset=utf-8">
	...
	<title>Login Mitra | {{ config("app.name") }} - {{ config('app.slogan') }}</title>
				...
				<div class="section bg-transparent min-vh-100 p-0 m-0 d-flex">
					<div class="vertical-middle">
						<div class="container py-5">
							...
							<div class="card mx-auto rounded-0 border-0 border-top border-info border-5" style="max-width: 400px;">
								<div class="card-body" style="padding: 40px;">
									<form id="login-form" name="login-form" class="mb-0" action="{{ url('app-affiliate/proses-masuk') }}" method="post">
										<h3>Login Affiliate</h3>
							...
							<div class="text-center text-muted mt-3"><small>Copyrights &copy; All Rights Reserved by Visit Cirebon ID</small></div>
