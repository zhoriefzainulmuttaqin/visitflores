                  ...
                  ============================================= -->
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 d-flex justify-content-between">
                                        ...
                                        <a href="{{ url('layanan-produk/tourism-card') }}" class="btn btn-warning">Tourism
                                            Card</a>
                                    </div>
                                </div>
                                <!-- Post Single - Share
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="d-flex">
                                                    @if ($tour->link_facebook != null)
                                                        <a target="_blank" href="{{ $tour->link_facebook }}"
                                                    ...
                                                    @if ($tour->link_youtube != null)
                                                        <a target="_blank" href="{{ $tour->link_youtube }}"
                                                    ...
                                                    @if ($tour->link_instagram != null)
                                                        <a target="_blank" href="{{ $tour->link_instagram }}"
                                                    ...
                                                    @if ($tour->link_tiktok != null)
                                                        <a target="_blank" href="{{ $tour->link_tiktok }}"
                                                            class="social-icon si-small text-white border-transparent rounded-circle bg-tiktok"
                                                            title="tiktok">
