				...
				<article class="entry event col-md-6 col-lg-4 mb-0 d-flex align-items-stretch">
					<div
						...
						<div class="col-12 p-4 pt-0 pb-1">
							...
							@if($shop->link_youtube != null || $shop->link_instagram != null || $shop->link_facebook !=
							null || $shop->link_tiktok != null)
							<div class="entry-meta no-separator mb-3">
								<ul>
									...
									<li><a href="{{ $shop->link_instagram }}" class="fw-normal text-dark"><i
