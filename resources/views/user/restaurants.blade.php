				...
				<article class="entry event col-md-6 col-lg-4 mb-0 d-flex align-items-stretch">
					<div
						...
						<div class="col-12 p-4 pt-0 pb-1">
							...
							@if($restaurant->link_youtube != null || $restaurant->link_instagram != null ||
							$restaurant->link_facebook != null || $restaurant->link_tiktok != null)
							<div class="entry-meta no-separator mb-3">
								<ul>
									@if($restaurant->link_youtube != null)
									<li><a href="{{ $restaurant->link_youtube }}" class="fw-normal text-dark"><i
												class="uil uil-youtube"></i> </a></li>
									@endif
									@if($restaurant->link_instagram != null)
									<li><a href="{{ $restaurant->link_instagram }}" class="fw-normal text-dark"><i
												class="uil bi-instagram"></i> </a></li>
									@endif
									@if($restaurant->link_facebook != null)
									<li><a href="{{ $restaurant->link_facebook }}" class="fw-normal text-dark"><i
