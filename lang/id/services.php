...
return [
    ...
    'tourism_card_detail_one' => "<b>Dapatkan kemudahan berwisata melalui produk kartu diskon kami yang dapat digunakan untuk memperoleh penawaran spesial/diskon spesial diberbagai hotel, restoran, tempat wisata, oleh-oleh, outlet yang telah menjadi mitra <span class='text-warning'>UJICOBANTT.ID</span>.</b> ",
    "tourism_card_detail_two" => "<b>Tourism Card :</b> Kartu diskon berbentuk e-card yang bisa anda dapatkan hanya dengan harga Rp.25.000 (berlaku 3 hari). <br> <br> Kemudahan Tourism Card dapat anda nikmati diberbagai fasilitas yang berada di Flores. ",
    "buy" => "Beli",
    "show_details" => "Lihat Lebih Lanjut",
    "link_web" => "Lihat Situs",
