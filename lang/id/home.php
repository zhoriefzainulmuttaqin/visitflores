...
return [
    ...
    "highlight_description_events" => "The Pioneer Of Attractions. Saksikan keseruan nya di Cirebon Aja.",
    "highlight_description_destination_360" => "Melihat destinasi Wisata dengan view 360°",
    "title_events" => "Event",
    "title_calender_events" => "Kalender Event",
    "title_destinations" => "Wisata",
    "title_culinaries" => "Kuliner",
    ...
    "subtitle_accommodations" => "Berikut ini daftar akomdasi yang dikunjungi wisatawan",
    "subtitle_service_products" => "Berikut ini daftar akomdasi yang dikunjungi wisatawan",
    "see_all" => "Lihat Semua",
